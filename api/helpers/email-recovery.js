...
module.exports = ({ usuario, recovery }, cb) => {
    const message = `
        ...
        <br />
        <p>
            Aqui está o link para redefinir a sua senha. Acesse-o e digite a nova senha.
        ...
        <br /><br /><hr />
        <p>
            Se você não solicitou a redefinição de senha, desconsidere este email
        </p>
        <br />
    ...
    const opcoesEmail = {
        from: "leonardonunesbrito@gmail.com",
        to: usuario.email,
